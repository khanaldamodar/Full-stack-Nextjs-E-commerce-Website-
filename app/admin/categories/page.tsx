  ...
  return (
    <div className='h-screen'>
        ...
        <div className="w-full flex items-center p-4 shadow-md justify-between bg-[#aec958]">
            ...
            <button onClick={() => router.push("/admin/categories/add")} className="bg-[#4998d1] rounded-2xl text-white px-4 py-2 hover:bg-green-100 transition">Add Category</button>
        </div>
